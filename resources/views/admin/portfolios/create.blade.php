...
<div class="admin-title-row">
    <div>
        <h1 style="font-size: 2rem;">Tambah Project Baru</h1>
        <p style="color: var(--text-secondary); font-size: 0.9rem;">Isi formulir berikut untuk mempublikasikan project portofolio baru Anda.</p>
    </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            <div class="admin-card" style="margin-bottom: 0;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Contoh: E-Commerce Web Application" value="{{ old('title') }}" required>
                    @error('title')
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 16px;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control" required>
                            ...
                            <option value="in-progress" {{ old('status') == 'in-progress' ? 'selected' : '' }}>Sedang Dikerjakan (In-Progress)</option>
                        </select>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 16px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="technology_used" id="technology_used" class="form-control" placeholder="Contoh: Laravel, MySQL, AlpineJS, Tailwind" value="{{ old('technology_used') }}">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 16px;">
                    <div class="form-group">
                        ...
                        <input type="url" name="demo_link" id="demo_link" class="form-control" placeholder="https://demo.contoh.com" value="{{ old('demo_link') }}">
                    </div>
                    
                    <div class="form-group">
                        <label for="github_link">Link Repositori GitHub (Optional)</label>
                        <input type="url" name="github_link" id="github_link" class="form-control" placeholder="https://github.com/username/project" value="{{ old('github_link') }}">
                    </div>
                </div>

                <div class="form-group" style="margin-top: 20px;">
                    <label for="description">Deskripsi Lengkap Project *</label>
                    <textarea name="description" id="description" rows="8" class="form-control" placeholder="Jelaskan mengenai fitur, arsitektur, dan cara kerja project Anda..." required>{{ old('description') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 24px; position: sticky; top: 100px;">
            <div class="admin-card" style="margin-bottom: 0;">
                ...
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 24px; font-size: 0.95rem;">
                    <input type="checkbox" name="is_featured" id="is_featured" value="1" style="width: 18px; height: 18px; accent-color: var(--accent); cursor: pointer;" {{ old('is_featured') ? 'checked' : '' }}>
                    <label for="is_featured" style="cursor: pointer; font-weight: 500;">Tampilkan sebagai Project Unggulan (Featured)</label>
                </div>
                
                <button type="submit" class="btn btn-primary" style="width: 100%;"><i class="fa-solid fa-circle-plus"></i> Publikasikan Project</button>
            </div>
