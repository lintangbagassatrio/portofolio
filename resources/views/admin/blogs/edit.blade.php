...
<div class="admin-title-row">
    <div>
        <h1 style="font-size: 2rem;">Edit Artikel</h1>
        <p style="color: var(--text-secondary); font-size: 0.9rem;">Formulir untuk memperbarui artikel blog Anda.</p>
    </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            <div class="admin-card" style="margin-bottom: 0;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Contoh: Belajar Clean Architecture dengan Laravel" value="{{ old('title', $blog->title) }}" required>
                    @error('title')
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 16px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tags" id="tags" class="form-control" placeholder="Contoh: laravel, php, coding" value="{{ old('tags', $tagString) }}">
                    </div>
                </div>

                <div class="form-group" style="margin-top: 20px;">
                    <label for="content">Isi Konten Artikel *</label>
                    <textarea name="content" id="content" rows="15" class="form-control" placeholder="Tulis artikel lengkap Anda di sini..." required>{{ old('content', $blog->content) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 24px; position: sticky; top: 100px;">
            <div class="admin-card" style="margin-bottom: 0;">
                ...
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control" required>
                        ...
                        <option value="published" {{ old('status', $blog->status) == 'published' ? 'selected' : '' }}>Terbitkan Artikel</option>
                    </select>
                </div>
                
                <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 20px;"><i class="fa-solid fa-floppy-disk"></i> Simpan Artikel</button>
            </div>
            ...
            <div class="admin-card" style="margin-bottom: 0; text-align: center;">
                ...
                <div class="image-preview-box" id="thumbnailPreviewContainer" style="margin: 0 auto 16px auto; width: 100%; height: 180px;">
                    @if($blog->thumbnail)
                        <img id="thumbnailPreview" src="{{ asset('storage/' . $blog->thumbnail) }}" alt="Preview" style="display: block; width: 100%; height: 100%; object-fit: cover;">
                    @else
